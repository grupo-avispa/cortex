...
REGISTER_TYPE(pm10, int, false)
REGISTER_TYPE(co2, int, false)
REGISTER_TYPE(tvoc, int, false)
REGISTER_TYPE(ch2o, int, false)
REGISTER_TYPE(co, float, false)
REGISTER_TYPE(o3, int, false)
REGISTER_TYPE(no2, int, false)
REGISTER_TYPE(toinflux,bool,false)
